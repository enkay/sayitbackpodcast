...
@section('content')
	<div class="mt-12 text-lg">
		...
		<ul class="list-disc list-inside">
			...
			<li class="mt-2">If you don't have either, you can buy this <a href="https://www.amazon.com/Sennheiser-PC-USB-Headset-line/dp/B005HWEZGG" target="_blank" class="underline">USB headset</a> that sounds great for $24. If you're on a newer computer, you may also need a <a href="https://www.amazon.com/AmazonBasics-Type-C-Gen1-Female-Adapter/dp/B01GGKYXVE/ref=sxin_15_ac_d_mf_rf?ac_md=4-2-QW1hem9uQmFzaWNz-ac_d_mf_rf_rf&cv_ct_cx=usb+c+to+usb+adapter&dchild=1&keywords=usb+c+to+usb+adapter&pd_rd_i=B01GGKYXVE&pd_rd_r=62190be3-5053-44b9-8795-4f213304937e&pd_rd_w=YrC2U&pd_rd_wg=yqNeJ&pf_rd_p=95fb715a-d44a-4a3c-ac61-fb2df95cb7e9&pf_rd_r=KDECFGJTNJVTVR0209C8&psc=1&qid=1633065786&sr=1-3-1db1fce3-1628-43df-a6c6-84620ba4aaaa" target="_blank" class="underline">USB-C to USB</a> adapter.</li>
		</ul>
