...
@section('content')
	<div class="mt-12 text-lg">
		...
		<ul class="list-disc list-inside">
			...
			<li class="mt-2">You will need an external microphone and wired headphones. Laptops built-in microphones and airpods won't work.</li>
		...
		<ul class="list-disc list-inside">
			...
			<li class="mt-2">You will need <a href="https://www.apple.com/us/shop/product/MMTN2AM/A/earpods-with-lightning-connector" target="_blank" class="underline">wired earpods</a> with a built-in microphone. Speakerphone and airpods won't work.</li>
		</ul>
