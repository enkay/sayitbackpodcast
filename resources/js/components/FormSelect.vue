<template>
	<select :class="{ 'bg-gray-100': !whiteBg, 'bg-white': whiteBg }" :id="'i-' + name" :value="modelValue" :name="name" @change="e => $emit('update:modelValue', e.target.value)" ref="select" :key="modelValue">
...
<style lang="scss" scoped>
	select {
		@apply appearance-none block p-3 border-2 border-gray-300 outline-none w-full rounded leading-normal text-base shadow-none;
